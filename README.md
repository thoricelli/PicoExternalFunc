...
To solve this, use the lsposed module that fixes this:
https://github.com/thoricelli/DockNoTob

## Installation

1. Download the ZIP file
2. Install it via Magisk
3. (Optionally) install the [dock lsposed module](https://github.com/thoricelli/DockNoTob).